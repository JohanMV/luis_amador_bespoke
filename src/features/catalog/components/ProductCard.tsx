    ...
    <article className="group min-w-0">
      ...
      <div className="flex min-w-0 items-start justify-between gap-2 pt-3 sm:gap-4 sm:pt-4">
        ...
        <div className="shrink-0 pt-3 text-right sm:pt-4">
          ...
          {product.rentalPrice && <p className="mt-1 max-w-20 text-[0.6rem] leading-snug text-ink-soft/80 sm:max-w-none sm:text-[0.7rem]">Alquiler desde S/ {product.rentalPrice.toLocaleString("es-PE")}</p>}
        </div>
      </div>
    </article>
  );
